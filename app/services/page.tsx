            ...
            {categories.map((cat) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  className={`px-4 py-2 rounded-lg font-sans text-xs sm:text-sm font-semibold transition-all whitespace-nowrap cursor-pointer ${
                    active
                ...
                >
                  ...
                  <div className="pt-6 mt-6 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                    <Link
                      ...
                      className="font-sans text-xs font-bold text-[#16A34A] hover:text-[#15803D] inline-flex items-center gap-1.5 transition-colors"
                    >
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="p-8 sm:p-12 rounded-3xl bg-slate-900 text-white border border-slate-800 shadow-xl flex flex-col lg:flex-row lg:items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 shrink-0">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-lg bg-[#16A34A] hover:bg-[#15803D] text-white font-sans text-xs font-semibold tracking-wider uppercase transition-colors text-center"
              >
              ...
              <Link
                href="/about"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-white font-sans text-xs font-semibold tracking-wider uppercase border border-slate-700 transition-colors text-center"
              >
